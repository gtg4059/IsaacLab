...
# Pre-defined configs
##
from isaaclab_assets import G1_DEX, G1_DEX_PICK # isort: skip
...
class G1Rewards(RewardsCfg):
    ...
    lifting_object = RewTerm(func=mdp.object_is_lifted, params={"minimal_height": 0.85}, weight=0.3)
...
class G1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        super().__post_init__()
        # Scene
        self.scene.robot = G1_DEX_PICK.replace(prim_path="{ENV_REGEX_NS}/Robot")
