...
def object_ee_distance(
    ...
    dist = torch.sqrt((1 - torch.tanh(torch.abs(distance1-0.28)/(std)))*(1 - torch.tanh(torch.abs(distance2-0.28)/(std))))+5*torch.sqrt((1 - torch.tanh(torch.abs(distance1-0.3)/(std**2)))*(1 - torch.tanh(torch.abs(distance2-0.16)/(std**2))))
