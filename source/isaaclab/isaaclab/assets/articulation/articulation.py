...
class Articulation(AssetBase):
    ...
    def write_joint_friction_coefficient_to_sim(
        ...
        if int(get_version()[2]) < 5:
            ...
            friction_props[physx_env_ids.cpu(), :, 0] = self._data.joint_friction_coeff.cpu()[physx_env_ids.cpu(), :]
    ...
    def write_joint_dynamic_friction_coefficient_to_sim(
        ...
        # set into simulation
        friction_props = self.root_physx_view.get_dof_friction_properties()
        friction_props[physx_env_ids.cpu(), :, 1] = self._data.joint_dynamic_friction_coeff.cpu()[physx_env_ids.cpu(), :]
    ...
    def write_joint_viscous_friction_coefficient_to_sim(
        ...
        # set into simulation
        friction_props = self.root_physx_view.get_dof_friction_properties()
        friction_props[physx_env_ids.cpu(), :, 2] = self._data.joint_viscous_friction_coeff.cpu()[physx_env_ids.cpu(), :]
