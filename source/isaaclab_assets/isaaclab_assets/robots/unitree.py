...
G1_DEX_FIX = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            # fda
            'left_hip_pitch_joint': -0.4653, 
            'left_hip_roll_joint': 0.1193,
            'left_hip_yaw_joint': -0.1053,
            'left_knee_joint': 0.9159,
            'left_ankle_pitch_joint': -0.5631,
            'left_ankle_roll_joint': 0.1233,
            'right_hip_pitch_joint': -0.4807,
            'right_hip_roll_joint': -0.0893,
            'right_hip_yaw_joint': 0.0967,
            'right_knee_joint': 1.0260,
            'right_ankle_pitch_joint': -0.5468,
            'right_ankle_roll_joint': 0.0773,
            "waist_yaw_joint": 0.0,
