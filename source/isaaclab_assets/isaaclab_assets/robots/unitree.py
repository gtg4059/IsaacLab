...
G1_DEX_FIX = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        # usd_path="./source/isaaclab_assets/data/Robots/g1_29dof_rev_1_0_with_inspire_hand_DFQ/g1_29dof_rev_1_0_with_inspire_hand_DFQ.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.76),
        joint_pos={
            # 'left_hip_pitch_joint': 0.0400,
            # 'left_hip_roll_joint': 0.0300,
            # 'left_hip_yaw_joint': -0.0800,
            # 'left_knee_joint': 0.1200,
            # 'left_ankle_pitch_joint': -0.1300,
            # 'left_ankle_roll_joint': -0.0400,
            # 'right_hip_pitch_joint': 0.0400,
            # 'right_hip_roll_joint': 0.0200,
            # 'right_hip_yaw_joint': 0.0300,
            # 'right_knee_joint': 0.1000,
            # 'right_ankle_pitch_joint': -0.1000,
            # 'right_ankle_roll_joint': -0.0100,
            # 'waist_pitch_joint': 0.0100,
            # 'waist_roll_joint': 0.0100,
            # 'waist_yaw_joint': 0.0000,
            # 'left_shoulder_pitch_joint': -0.0100,
            # 'left_shoulder_roll_joint': 0.3000,
            # 'left_shoulder_yaw_joint': 0.1000,
            # 'left_elbow_joint': -0.0000,
            # 'left_wrist_roll_joint': -0.2000,
            # 'left_wrist_pitch_joint': -0.0100,
            # 'left_wrist_yaw_joint': 0.0000,
            # 'right_shoulder_pitch_joint': -0.0000,
            # 'right_shoulder_roll_joint': -0.0900,
            # 'right_shoulder_yaw_joint': -0.3000,
            # 'right_elbow_joint': 0.0000,
            # 'right_wrist_roll_joint': 0.2000,
