...
G1_DEX = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            # #"left_shoulder_pitch_joint": 0.2,#1.047-0.3,
            # "right_shoulder_roll_joint": -0.2,
            # #"right_shoulder_pitch_joint": -0.2,#1.047+0.3,
...
G1_DEX_PICK = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.74),
        joint_pos={
            'left_hip_pitch_joint': -0.3733, 
            'right_hip_pitch_joint': -0.3895, 
            'waist_yaw_joint': -0.0061, 
            'left_hip_roll_joint': 0.1076,
            'right_hip_roll_joint': -0.0773, 
            'waist_roll_joint': -0.0537, 
            'left_hip_yaw_joint': -0.0197, 
            'right_hip_yaw_joint': -0.0582, 
            'waist_pitch_joint':  -0.0997,
            'left_knee_joint':  0.9670, 
            'right_knee_joint': 0.9850, 
            'left_shoulder_pitch_joint': 1.0998, 
            'right_shoulder_pitch_joint': 1.0546, 
            'left_ankle_pitch_joint': -0.5121, 
            'right_ankle_pitch_joint': -0.5128, 
            'left_shoulder_roll_joint': 0.1681, 
            'right_shoulder_roll_joint': -0.1483,
            'left_ankle_roll_joint': -0.2618, 
            'right_ankle_roll_joint': 0.2618, 
            'left_shoulder_yaw_joint': -0.1100, 
            'right_shoulder_yaw_joint': 0.0440, 
            'left_elbow_joint': -1.0472, 
            'right_elbow_joint': -1.0472, 
            'left_wrist_roll_joint': -0.2135, 
            'right_wrist_roll_joint': 0.1524,
            'left_wrist_pitch_joint':  0.0667, 
            'right_wrist_pitch_joint': 0.0578, 
            'left_wrist_yaw_joint': -0.1368, 
            'right_wrist_yaw_joint': 0.0768, 
            'L_index_proximal_joint': 0.2943, 
            'L_middle_proximal_joint': 0.2901, 
            'L_pinky_proximal_joint': 0.2897, 
            'L_ring_proximal_joint': 0.2878,
            'L_thumb_proximal_yaw_joint': -0.0238, 
            'R_index_proximal_joint': 0.3000, 
            'R_middle_proximal_joint': 0.3003, 
            'R_pinky_proximal_joint': 0.8625, 
            'R_ring_proximal_joint': 0.3009, 
            'R_thumb_proximal_yaw_joint': -0.0110, 
            'L_index_intermediate_joint': -0.0569, 
            'L_middle_intermediate_joint': -0.1564, 
            'L_pinky_intermediate_joint': -0.2596, 
            'L_ring_intermediate_joint': -0.2077, 
            'L_thumb_proximal_pitch_joint': 0.5160, 
            'R_index_intermediate_joint': 0.2055, 
            'R_middle_intermediate_joint': 0.2010, 
            'R_pinky_intermediate_joint': -0.3400, 
            'R_ring_intermediate_joint': 0.2363, 
            'R_thumb_proximal_pitch_joint': 0.5201, 
            'L_thumb_intermediate_joint': 0.7478, 
            'R_thumb_intermediate_joint': 0.7739, 
            'L_thumb_distal_joint':  1.2975, 
            'R_thumb_distal_joint': 1.3425
