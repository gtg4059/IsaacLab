...
parser.add_argument("--checkpoint_run", type=str, default=None, help="Checkpoint file to resume run from.")
parser.add_argument("--checkpoint_stop", type=str, default=None, help="Checkpoint file to resume stop from.")
...
def main():
    ...
    policy_run = torch.jit.load("./logs/rsl_rl/g1_flat/2025-08-21_21-48-22/exported/policy.pt")
    policy_stop = torch.jit.load("./logs/rsl_rl/g1_flat/2025-08-22_17-57-19/exported/policy.pt")
